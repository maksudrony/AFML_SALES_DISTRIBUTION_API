...
{
    public interface IAverageRateRptRepository
    {
        Task<AverageRateRptResponseDto> GetAverageRateRptFromDbAsync(DateTime? fromDate, DateTime? toDate, DateTime? dayFromDate, DateTime? dayToDate,
